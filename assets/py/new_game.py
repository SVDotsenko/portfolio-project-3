...
from assets.py.validations import (validate_was_coordinate_used,
                                   validate_is_game_over)
...
def new_game(human_board, computer_board):
    ...
    Args: human_board (Board): The board representing the human player's
    ships. computer_board (Board): The board representing the computer
    player's ships.
    """
    ...
    print(f'Player: {computer_board.count_hits()}. '
          f'Computer: {human_board.count_hits()}')
    print_symbol(EQUAL_SIGN, 33)
